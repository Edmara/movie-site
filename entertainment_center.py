...
# Criaçao de instancia da da Classe movie
new_hope = media.Movie('Star Wars Episódio IV: Uma Nova Esperança',
                       'Storyline',
                       'https://www.barakashop.co.za/media/catalog/product/cache/1/image/650x'
                       '/040ec09b1e35df139433887a97daa66f/s/t/star_wars_a_new_hope_poster.jpg',
...
attack_of_the_clones = media.Movie('Episódio II - Ataque dos Clones',
                                   'Storyline',
                                   'http://crushingkrisis.com/assets'
                                   '/Star_Wars_Episode_II_Attack_of_the_Clones_theatrical_poster-300x442.jpg',
                                   'https://www.youtube.com/watch?v=n7DQ9SdjUmg')

revenge_of_sith = media.Movie('Episódio III - A Vingança dos Sith',
                              'Storyline',
                              'https://vignette.wikia.nocookie.net/swfans/images/a/a6/RevengeOfTheSithPoster.jpg'
                              '/revision/latest/scale-to-width-down/321?cb=20130726070536',
                              'https://www.youtube.com/watch?v=5UnjrG_N8hU')

# Passando para um array movie que sera enviado para fresh tomatoes open_movies_page func
